...
/**
 * DminscripcionSearch represents the model behind the search form of `app\models\Dminscripcion`.
 */
class DminscripcionSearch extends Dminscripcion
{
    /**
     * {@inheritdoc}
     */
