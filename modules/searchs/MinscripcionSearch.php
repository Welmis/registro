...
/**
 * MinscripcionSearch represents the model behind the search form of `app\models\Minscripcion`.
 */
class MinscripcionSearch extends Minscripcion
{
    /**
     * {@inheritdoc}
     */
