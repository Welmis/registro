...
$this->title = 'Listado de Entregas de  Certificados de Inscripción de Vehiculos';
...
<div class="dcertifico-index">
    ...
    <p>
        <?= Html::a('Add Entrega de  Certificados de Inscripción de Vehiculos', ['create'], ['class' => 'btn btn-success']) ?>
		<?=ExportMenu::widget([
